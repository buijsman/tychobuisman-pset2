 ...
 * tycho.tychobuisman_pset2.Story.java
 * Madlibs
 *
 ...
 * A tycho.tychobuisman_pset2.Story is Serializable, so it can be packed into an Intent as "extra" data.
 */
...
public class Story implements Serializable {
    ...
    /** constructs a new tycho.tychobuisman_pset2.Story reading its text from the given input stream */
